...
1. [BUG] - Menu popping up when dragging to resize a column. Need to fire a COLUMN_DRAG_START event and cancel the long-click timeout on it
...
1. [PERF] - Horizontal scrolling is sloooowwwwww with the menu.
